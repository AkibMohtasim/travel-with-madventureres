...
const Footer = () => {
  return (
    <footer className="footer p-10 bg-neutral text-neutral-content">
      <div>
        <p className='custom-font text-4xl'>MAdventurers</p>
        <p className='adventure-font'>Adventuring with the like minded people <br />Since 2004</p>
      </div>
      <div>
        <span className="footer-title adventure-font">Social</span>
